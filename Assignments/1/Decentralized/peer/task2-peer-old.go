...
func main() {
	...
	ipandport = listenToIP + ":" + listenToPort // COMMENT DURING DEMO: THIS IS NOT CORRECT
	...
	thisPeer.id = hash(ipandport) // COMMENT DURING DEMO: THIS CAUSES HASHES TO BE SAME, I SHOULD TYPE THE PUBLIC IP HERE
